...
define config.name = "Doki Doki Switcheroo"
...
define build.name = "Doki Doki Switcheroo Demo"
...
define config.save_directory = "Switcheroo"

# icon displayed on taskbar / dock
define config.window_icon = "/mod_assets/gui/modLogo.png"
