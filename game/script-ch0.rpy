label ch0_main:
    ...
    "I, meanwhile, have always overslept, often to the point of missing school."
    "So, since Satori wakes up first, he makes sure to come get me, too."
    ...
    mc "Fine! I'm up already!" #call the FeMC variable "mc", since she is still the Main Character, and Ren'Py has defined it like that.
    ...
    "...who doesn't?"
    "But most of the time he's as chipper as can be."
    ...
    s 5p "It's not funny!"
    s 5j "Those things will rot your mind."
    ...
    "He blushes a little and looks away."
    ...
    s 1n "Eh?"
    s 1g "You told me a couple weeks ago that you were going to look into joining a club."
    s 1h "Don't you remember?"
    "I sigh."
    ...
    s 5h "You better not get detention today, or I'll be super disappointed."
    mc "Don't worry."
    ...
    show yuuri 1b at t21
    show natsuko 1l at t22
    ...
    show yuuri at thide
    hide yuuri
    "The feisty little dude, whose name apparently is Natsuko, (...isn't that a girl's name? No wonder he doesn't like to go by it...) is the one I don't recognize."
    "His small stature makes me think he must be a first-year."
    "He must have caught me looking at him."
    show natsuko 1ab at t11
    ...
    show satori 1a at t32
    show natsuko 1a at t31
    show yuuri 1a at t33
    s 7x "This is Natsuko, always full of energy."
    s 7z "And this is Yuuri. He's the smartest one in the club." #Change
    $ y_name = "Yuuri"
    ...
    m 3m "Even if I'm the one promoting it."
    "My eyes suddenly enlarge."
    ...
    m 6c "Look, I understand how literature can be dull for someone like you."
    ...
    show mateo 6k at l21
    show yuuri 1j at t22
    m 6k "Hahahas!"
    ...
    show natsuko 7s at h41
    show yuuri 7v at h44
    show mateo 3x at t42
    "Yuuri and Natsuko fidget nervously."
    "Satori suddenly stands up."
    show satori 5r at t42
    show mateo 3x at t43 #FIX
    s "Yeah, let's do it!"
    n 1q "..."
    y 7o "..."
    s 4h "C'mon guys."
    ...
    y 3l "After all, the truest form of writing is writing to oneself." #FIX
    ...
    s 5l "Well, in my defense, they're not hot to me..."
    "Fair point."
    ...
    s "Natsu likes simple writing using words that are..."
    ...
    show satori 1a at t41
    "Satori..."
    show natsuko 1a at t42
    "Natsuko.."
    show yuuri 1a at t43
    "Yuuri..."
    show mateo 6a at t44
    "... and even Mateo."
    hide satori
    hide natsuko
    hide yuuri
...
label demo_end:
    ...
    mc "This is the end of the Doki Doki Switcheroo demo!"
    mc "If you're as eager as I am to write a poem for one of the hot guys in the club..."
    mc "Stay tuned for the next demo, or even the full mod release, coming soon!"
    mc "Thanks for playing, [player]!"
    $ renpy.full_restart()
